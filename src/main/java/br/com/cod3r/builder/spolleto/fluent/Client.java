...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        Pasta p2 = new PastaBuilder(Size.SMALL).withToppings("Bacon", "Broccoli").withSauces("Tomato").withCheese().now();
        System.out.println(p2);

        Pasta p3 = new PastaBuilder(Size.STANDARD)
                .withToppings("Garlic").withSauces("Fungi", "Cheese").withCheese().withPepper().now();
